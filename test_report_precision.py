...
# 1) typo: ITM010 ชัด → clear ; ITM011 (fuzzy ทุกกรณี) → soft [ADR-098 กัน FP ศัพท์ช่าง/แบ่งคำ
#    เช่น 'ชุบสังกะสี'→'บสังกะสี'] ; ITM011 ที่ co-located กับ ITM010 → clear ผ่าน consensus (เคส 9)
...
chk(tier("ITM011", detail='#3: "เจียร" → "เจียร์"') == "soft", "ITM011 (fuzzy เดี่ยว) → soft [ADR-098]")
