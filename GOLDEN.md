...
# ปัจจุบัน: 35b2f7c8...  (golden ทางการ: 106 ไฟล์ /mnt/project, 834 บิล)
```
...
|---|---|---|
| **`35b2f7c8`** | ✅ **golden ปัจจุบัน** — 106 ไฟล์ / 834 บิล | `regression_full.py . <data>` |
| `d8bcde85` | fixture golden (3 บิล, เร็ว — ไม่ต้องใช้ข้อมูลจริง) | `INVARIANTS/check_invariants.py` |
