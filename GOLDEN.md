...
# ปัจจุบัน: ba9deda0...  (golden ทางการ: 148 ไฟล์ /mnt/project, 1056 บิล)
```
...
|---|---|---|
| **`ba9deda0`** | ✅ **golden ปัจจุบัน** — 148 ไฟล์ / 1056 บิล — path-independent (ADR-037) · rebaseline ADR-051 (DT001 "012" filename parse fix + ITM007/ITM015→advisory) · ฐาน 148 ไฟล์ ADR-048 | `regression_full.py . <data>` |
