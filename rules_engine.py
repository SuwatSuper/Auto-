...
from rules_engine_rules_a import *  # noqa: F401,F403
from rules_engine_rules_b import *  # noqa: F401,F403
from rules_engine_rules_c import *  # noqa: F401,F403
...
RULES = {
    ...
    'ITM008':{'name':'ราคา outlier','severity':'WARNING','category':'รายการสินค้า','check':r_itm008,'enabled':True},
