...
class ReportAgent(Agent):
    ...
    def _run(self, ctx: PipelineContext) -> AgentResult:
        ...
        try:
            ...
            # [L9] surface error ก่อน fallback — เดิมกลืนเงียบ ทำให้ไฟล์ไปโผล่ที่ cwd โดยผู้ใช้ไม่รู้ตัว
            print(f'   ⚠️ สร้างโฟลเดอร์รายงาน {report_dir!r} ไม่ได้ ({type(e).__name__}: {e}) → ใช้ {os.getcwd()}')
