...
def bill_ref(b: dict) -> dict:
    ...
    return {
        ...
        # [DISPLAY-FAITHFUL] โชว์เลขที่เอกสาร "ดิบตามใบจริง" (มีขีด/อักขระเดิม) — เดิมใช้ iv_number (normalized ตัดขีด) ทำให้รายงานโชว์เลขไม่ตรงบิล. logic ใช้ key แยกจาก iv_number อยู่แล้ว → จุดนี้ display ล้วน
        "iv": str(b.get("iv_number_raw") or b.get("iv_number") or "-"),
    }
