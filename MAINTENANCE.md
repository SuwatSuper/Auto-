...
1. **Golden hash ห้ามขยับโดยไม่ตั้งใจ.** ผลตรวจ (audit decision) ถูก fingerprint ด้วย SHA256.
   ...
   PYTHONHASHSEED=0 PUOPUY_AUDIT_DATE=2026-06-02 \
     python3 regression_full.py . tests/fixtures tests/fixtures/baseline_fixture.json   # b5c415bb… (fixture)
     python3 golden_master.py . /tmp/x.json /mnt/project                                # 08e6abfd… (148 ไฟล์ ทางการ)
     python3 regression_full.py . <106-ไฟล์จริง>                                         # 08e6abfd… (ทางการ)
   ```
