...
FIELD_CODES = [
    ('ชื่อบริษัท', ['CMP001','CMP002','CMP003','CMP004','CMP005']),
    ('ที่อยู่', ['ADDR001','ADDR002','ADDR003','ADDR004','ADDR005']),
    ('เลขที่ผู้เสียภาษี', ['TAX001','TAX002','TAX003','TAX004','TAX005','TAX006','TAX007']),
    ('สาขา/สนญ.', ['BR001','BR002','BR003']),
    ('เลขที่ IV', ['DOC002','DOC003','IV001','IV002','IV003','IV004','IV005']),
    ('วันที่', ['DOC001','DT001','DT002','DT003','DT004','DT005']),
    ('รายการสินค้า', ['ITM001','ITM002','ITM003','ITM004','ITM005','ITM006','ITM007','ITM008','ITM009','ITM010','ITM011','ITM012','ITM013','ITM014','ITM015','ITM016','ITM017','ITM018']),
    ('ยอดก่อน VAT', ['VAT001','VAT005','VAT006','VAT009']),
    ('ยอดหลัง VAT', ['VAT002','VAT003','VAT004','VAT007','VAT008','VAT010']),
]
