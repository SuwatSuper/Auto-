...
# [ADR-123] 'อิฐบล็อค' เลิกฟ้องแล้ว (whitelist กลุ่ม B — block: บล็อก/บล็อค ใช้ทั้งคู่) → ใช้ 'หล็กฉาก' แทน
#   (typo จริงกลุ่ม A: ตก เ จาก 'เหล็กฉาก' — ITM011 fuzzy ~93%, ไม่ whitelist) ล็อก recall ITM011 run ≤20 ตัว
out_b2 = B.r_itm011({"items": [_it(2, "หล็กฉาก 3 มม. มอก.")]}, None, {})
check(len(out_b2) >= 1, "'หล็กฉาก' → ยังฟ้อง (recall ของคำ run ≤20 ไม่หาย)")
