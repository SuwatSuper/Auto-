...
# 'แผ่นเจียร์' (TKH_69_0513) — ยังฟ้อง (เก็บไว้รอเจ้าของเคาะ ไม่ถูก fix กลบ)
out_b2 = B.r_itm011({"items": [_it(5, "แผ่นเจียร์ MAKITA ขนาด 4 นิ้ว")]}, None, {})
check(len(out_b2) >= 1, "'แผ่นเจียร์' → ยังฟ้อง (recall ของคำ run ≤20 ไม่หาย)")
