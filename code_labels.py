...
MAP = {
    ...
    # [ADR-190] ตัวอักษรไทยเขียนผิดรูปในชื่อบริษัท (นิคหิต+สระอา แทน สระอำ) — ตาเห็นเหมือนกัน
    #   แต่คนละ byte → จับคู่ ภ.พ.20/ค้นหา/ส่งออกไประบบอื่นจะไม่ตรง. เดิม normalize เงียบ ไม่เคยแจ้ง.
    "CMP007": (F_NAME, "ตัวอักษรในชื่อบริษัทเขียนผิดรูป", FIX),
    # ที่อยู่
    ...
    "ADDR010": (F_ADDR, "จังหวัดไม่ใช่จังหวัดจริง", CHECK),
    "ADDR011": (F_ADDR, "ตัวอักษรในที่อยู่เขียนผิดรูป", CHECK),   # [ADR-190] คู่กับ CMP007     # [ADR-122] จังหวัดสะกดผิด/ปลอม
    # เลขภาษี
