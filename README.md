...
- ✅ **Regression บนข้อมูลจริง** — ถามโฟลเดอร์ข้อมูล แล้วตรวจว่าได้ `ec61907f…`
...
| 2b. CI + ข้อมูลจริง | เพิ่ม regression เต็มบนโฟลเดอร์ที่ระบุ (`ec61907f`) |
| 3. Golden (sandbox) | golden hash → `f1ac8421` |
...
python3 regression_full.py . <โฟลเดอร์ข้อมูลจริง>    # ต้องได้ ec61907f ทั้ง 3 บรรทัด
```
...
| สิ่ง | hash | ตรวจด้วย |
|---|---|---|
| Golden ทางการ 81 ไฟล์ (632 บิล) | `ec61907f…` | `regression_full.py . <81-dir>` |
| Golden sandbox 106 ไฟล์ (836 บิล) | `f1ac8421…` | `golden_master.py . out.json /mnt/project` |
