...
_FAMILIES = [
    ...
    # — นับชิ้น/ชุด —
    {'key': 'ชิ้น', 'kind': 'count',
     # [ADR-166] + 'ตัว','อัน' — เคสจริงลูกค้า: "ตัว" คู่ "pc" ในใบเดียว ไม่ถูกจับ เพราะ ตัว/อัน
     #   เดิมอยู่แค่ _EXTRA_VALID_TH (ไม่มีตระกูล) → คนละ family กับ pc = หลุดเงื่อนไขปนภาษา.
     #   ปลอดภัย: เช็คปนภาษาจับเฉพาะ th↔en ในตระกูลเดียว (ชิ้น+ตัว = th ทั้งคู่ → ไม่ flag กันเอง)
     'th': {'ชิ้น', 'ตัว', 'อัน'},
