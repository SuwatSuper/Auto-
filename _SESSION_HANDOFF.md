...
- **golden hash จริง (148 ไฟล์ `/mnt/project`) = `31013a31`** · **fixture = `72cb832c…`** (เต็ม: `72cb832c9b667e796b86a78ec5e1b0556c9f19b50d15d7756df1cbd0a58e1f0a`)
- คงเส้น: `engine_hash == agent_hash == baseline_hash` เสมอ (ชั้น agent/advisory ห้ามเปลี่ยนผลตรวจหลัก)
- คอร์ปัสทางการ = **148 ไฟล์ (`/mnt/project`)** → golden `31013a31…` (engine==agent==baseline). สาย 81 ไฟล์ปลดระวาง (ดู ADR-019).
