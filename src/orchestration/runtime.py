...
class PipelineRuntime:
    ...
    def _make_money_agents(self, bus: EventBus, prices: str) -> dict[str, AgentLike]:
        ...
        treasury = TreasuryAgent(bus, _TOPIC_TREASURY, self.logger, limits, store)
        params = TradeParams(
    ...
    def status(self) -> dict[str, object]:
        ...
        return {
            ...
            "execution_warning": (
                "Live order routing is NOT implemented. Orders are simulated "
                "against live prices for safety. To enable live execution, "
                "add a signed Bitkub REST adapter and remove this banner."
            ),
