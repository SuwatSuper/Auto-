...
class Settings(BaseSettings):
    ...
    # H6: cap how many times the watchdog auto-restarts a crashing agent before
    # giving up (0 = unlimited), and the base for the exponential backoff between
    # attempts — so a deterministically-crashing agent can't storm the loop.
    max_agent_restarts: int = 10
    agent_restart_backoff_s: float = 2.0
