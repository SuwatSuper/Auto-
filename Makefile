...
help:
	...
	@echo "  make regression      - regression engine==agent บน fixture (hash d05e5de3)"
	...
	@echo "  make regression-real DATA=<dir> - regression เต็มบนข้อมูลจริง (baseline 814c7cf0, 146 ไฟล์)"
	@echo "  make agents-real DATA=<dir>     - สัญญา agent + เช็คเลข baseline (ต้องมี 146 ไฟล์)"
