...
def main():
    ...
    if not cur_fix:
        ...
        RETIRED_FIXTURE_PREFIXES = ('d8bcde85', '269ddaed')   # 269ddaed ปลดระวาง 2026-06-21 (ADR-058 SHORT guard: fixture ชีต 2/4/6 เลิกฟ้อง DOC001 → b5c415bb) · d8bcde85 = fixture hash ก่อน ADR-041 (float decimal tail) — ปลดระวาง
