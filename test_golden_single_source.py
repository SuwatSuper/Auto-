...
OPERATIONAL_SURFACES = [
    ...
    'อ่านก่อน_CLAUDE_CODE.md',     # [ADR-160] onboarding/read-first — เคยค้าง 23b315e8 → session ใหม่คาด golden ผิด → เฝ้าถาวร
    'อ่านก่อน_งานMASTERJOIN.md',   # [ADR-160] onboarding/read-first (master-join) — เคยค้าง 23b315e8 → เฝ้าถาวร
]
...
def main():
    ...
    if not cur_fix:
        ...
        RETIRED_FIXTURE_PREFIXES = ('72cb832c', 'd8bcde85', '269ddaed', 'b5c415bb')   # 72cb832c ปลดระวาง 2026-06-28 (ADR-122 — เพิ่ม field total_text + ADDR010 flag จังหวัด 'ทดสอบ'/'สาม' ใน fixture → ad0c9dad) · b5c415bb ปลดระวาง 2026-06-26 (ADR-102 — ลบ master ฉี อัน → fixture rebaseline 72cb832c) · 269ddaed ปลดระวาง 2026-06-21 (ADR-058 SHORT guard: fixture ชีต 2/4/6 เลิกฟ้อง DOC001 → b5c415bb) · d8bcde85 = fixture hash ก่อน ADR-041 (float decimal tail) — ปลดระวาง
