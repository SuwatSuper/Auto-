...
if len(VIEWERS) != 10:  # [F-4] เดิม assert (หายภายใต้ python -O) → raise ชัดเจน คงการตรวจ invariant เสมอ
    raise RuntimeError(f"VIEWERS ต้องมี 10 ตัว (พบ {len(VIEWERS)}) — โครงสร้างเพี้ยน")
