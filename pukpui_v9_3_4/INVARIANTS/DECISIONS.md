...
|---|---|---|---|
| **ข้อมูลจริง (ทางการ) — `/mnt/project`** | 148 | `ba9deda0…` (= `baseline.json._sha256`) | ผู้ใช้รันยืนยันบนเครื่องตน · engine==agent==baseline (1056 บิล) · rebaseline ADR-021 |
