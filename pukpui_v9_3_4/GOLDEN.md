...
# ปัจจุบัน: 31013a31...  (golden ทางการ: 148 ไฟล์ /mnt/project, 1056 บิล — master ว่าง ไม่มีบริษัทฝัง)
```
...
|---|---|---|
| **`31013a31`** | ✅ **golden ปัจจุบัน** — 148 ไฟล์ / 1056 บิล — rebaseline 2026-06-27 (ADR-104/105/106: P1 ตรวจหน่วยปนภาษาราย-**ไฟล์** [report-layer, golden-neutral — ตัด FP ฉี อัน ที่เกิดจากรวมข้ามไฟล์ผู้ขาย] · P2 ตัดอักขระความกว้างศูนย์ ZWNJ + กรองหัวคอลัมน์ 'Unit' หลุด + แก้คำ "ดึงมาไม่ครบ"→"ช่องหน่วยว่างในต้นฉบับ" · P3 **ITM020** "ทั้งบิลไม่มีหน่วยสินค้า") → ITM020 +52 (TOR_67_08/TOR_69_05), ITM019 +9 (header 'Unit' ถูกตรวจเป็นหน่วยขาด), ลบ 0, FP=0 · path-independent (ADR-037) | `regression_full.py . <data>` |
