...
# รหัสเลน "ข้อสังเกต" (review) — ไม่ใช่ must-fix (ตรงกับ config.REVIEW_CODES)
# [M6] ครบทุกรหัสเลน review ตาม code_labels.MAP (source of truth) — เดิมตกหล่น
#   ITM003/ITM007/VAT006/VAT010 → "ข้อสังเกตล้วน" ถูกจัดผิดเป็น "ต้องแก้".
REVIEW_ONLY = {"ITM003", "ITM004", "ITM005", "ITM007", "ITM009", "ITM012",
               "IV001", "VAT006", "VAT008", "VAT010"}
