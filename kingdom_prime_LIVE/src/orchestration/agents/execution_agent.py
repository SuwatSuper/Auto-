...
# (enforced by tests/architecture/test_execution_guard.py). The factory
# lives here so the composition root / runtime can obtain a live gateway
# without ever naming bitkub_rest. The import is function-local to satisfy
