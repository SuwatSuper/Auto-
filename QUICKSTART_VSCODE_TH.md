...
## 5) ยืนยัน golden จริง 81 ไฟล์ — Task `3b` / `5`
ครั้งแรกที่นำชุดข้อมูลทางการมา ให้ยืนยันว่าได้ hash `ec61907f…`:
`Run Task → "5. Regression บนข้อมูลจริง"` → ใส่ path โฟลเดอร์ 81 ไฟล์
