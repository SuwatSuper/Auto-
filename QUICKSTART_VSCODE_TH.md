...
## 5) ยืนยัน golden จริง (106 ไฟล์ `/mnt/project`) — Task `3b` / `5`
ครั้งแรกที่นำชุดข้อมูลทางการมา ให้ยืนยันว่าได้ hash `35b2f7c8…`:
`Run Task → "5. Regression บนข้อมูลจริง"` → ใส่ path โฟลเดอร์ /mnt/project (106 ไฟล์)
