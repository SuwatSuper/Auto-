...
## 5) ยืนยัน golden จริง (152 ไฟล์ `/mnt/project`) — Task `3b` / `5`
ครั้งแรกที่นำชุดข้อมูลทางการมา ให้ยืนยันว่าได้ hash `f05358aa…`:
`Run Task → "5. Regression บนข้อมูลจริง"` → ใส่ path โฟลเดอร์ /mnt/project (152 ไฟล์)
