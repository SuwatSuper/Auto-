# QUICKSTART — ปุ้มปุ้ย v9.3.5 บน VS Code (ฉบับ Offline)
...
## 5) ยืนยัน golden จริง (146 ไฟล์ `/mnt/project`) — Task `3b` / `5`
ครั้งแรกที่นำชุดข้อมูลทางการมา ให้ยืนยันว่าได้ hash `814c7cf0…`:
`Run Task → "5. Regression บนข้อมูลจริง"` → ใส่ path โฟลเดอร์ /mnt/project (146 ไฟล์)
