...
- **golden hash จริง (106 ไฟล์ `/mnt/project`) = `d6b23d12`** · **fixture = `269ddaed…`** (เต็ม: `269ddaed0c6dd34c735bc09a35dbe82f7b228dc62d424f2b13a740d51aaa34c1`)
- คงเส้น: `engine_hash == agent_hash == baseline_hash` เสมอ (ชั้น agent/advisory ห้ามเปลี่ยนผลตรวจหลัก)
- คอร์ปัสทางการ = **106 ไฟล์ (`/mnt/project`)** → golden `d6b23d12…` (engine==agent==baseline). สาย 81 ไฟล์ปลดระวาง (ดู ADR-019).
